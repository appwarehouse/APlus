...
namespace APlus.DataAccess.Migrations
{
    ...
    [Migration("20230711220016_AddTreatmentTypeActiveDefaultValueToTrue")]
    partial class AddTreatmentTypeActiveDefaultValueToTrue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APlus.DataAccess.Models.TreatmentTypeLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TreatmentTypeLocation");
                });
            ...
            modelBuilder.Entity("APlus.DataAccess.Models.TreatmentTypeLocation", b =>
                {
                    b.HasOne("APlus.DataAccess.Models.Location", "Location")
                        .WithMany("TreatmentTypeLocations")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APlus.DataAccess.Models.TreatmentType", "TreatmentType")
                        .WithMany("TreatmentTypeLocations")
            ...
            modelBuilder.Entity("APlus.DataAccess.Models.Location", b =>
                {
                    ...
                    b.Navigation("TreatmentTypeLocations");
                });
